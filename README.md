...
```shell
java -Dspring.profiles.active=production -jar ./build/libs/web-techno-cursach-0.0.1-SNAPSHOT.jar
```
...
```shell
gradlew bootBuildImage --imageName=org.is1di/web-techno-cursach
```
